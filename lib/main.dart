...
class _MyAppState extends State<_MyApp> {
  ...
  final _url = 'https://world.openfoodfacts.org/api/v0/product/';
  ...
  void apiConnexionResponse(product) async {
    print('code de produit: ' + product);
    var response = await http.get(_url + product);
    if (response.statusCode == 200) {
      var jsonResponse = convert.jsonDecode(response.body);
      print(jsonResponse.product);
    } else {
  ...
  Future scan() async {
    try {
      ...
      apiConnexionResponse(scanResult.rawContent);
